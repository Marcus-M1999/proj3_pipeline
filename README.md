...
- Your latest mobile game has two events you're interested in tracking: `request_group` & `accept_member`

- Each has metadata characterstic of such events (i.e., time, host,
  etc)
